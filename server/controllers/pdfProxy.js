...
// Cloudinary ไม่อนุญาตให้แสดง raw files เช่น PDF ผ่าน URL ตรง หากบัญชีถูกจัดอยู่ในสถานะ "untrusted" ก็คือยังไม่ verified 
// หรืออยู่ในแผนฟรี ถ้าเปิดลิงก์ PDF ผ่านเบราว์เซอร์โดยตรงจะเจอ error จึงต้องใช้ ตัวกลาง (Proxy server)
