...
const FormCountry = () => {
    ...
    const fetchCountries = async (form) => {
        setLoading(true)
        try {
            const res = await getCountry(token, currentPage, limit, form || {})
        } catch (err) {
    ...
    return (
        <>
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-2'>
                ...
                <div className='p-4 sm:p-6 bg-white shadow-sm ring-1 ring-gray-200/70 w-full rounded-2xl mt-4'>
                    <div className='flex items-center gap-3'>
                        ...
                        <h1 className='text-lg sm:text-xl font-semibold text-gray-800'>เพิ่มประเทศ</h1>
                    </div>
                ...
                <div className='p-4 sm:p-6 bg-white shadow-sm ring-1 ring-gray-200/70 w-full rounded-2xl mt-4'>
                    <div className='flex items-center gap-3 mb-6'>
                        ...
                        <h1 className='text-lg sm:text-xl font-semibold text-gray-800'>ค้นหาประเทศ</h1>
                    </div>
            ...
            <div className='overflow-x-auto bg-white shadow-sm ring-1 ring-gray-200/70 rounded-2xl mt-6 p-4 sm:p-6'>
                <h2 className='text-lg font-semibold text-gray-800 mb-4'>รายการประเทศ</h2>
