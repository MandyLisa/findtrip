                        ...
                        <div>
                            ...
                            <div className='relative'>
                                <input
                                    ...
                                    name='password'
                                    className='w-full border border-gray-300 p-2 rounded-lg pr-10' // pr-10 เผื่อที่ด้านขวาให้ไอคอน
                        ...
                        <div>
                            ...
                            <div className='relative'>
                                ...
                                <button
                                    type='button'
                                    className='absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700'
                                    onClick={() => setShowConfirmPassword(!showConfirmPassword)} // สลับสถานะการแสดงรหัสผ่าน
                                >
