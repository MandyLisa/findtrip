            ...
            {bookingStatus === 'PAID' && (
                <div className='bg-green-100 text-green-700 border border-green-400 rounded-md p-4 my-4 flex flex-col gap-3'>
                    <div className='flex items-center gap-2'>
                        ...
                        <span>ชำระเงินสำเร็จ! การจองของท่านได้รับการยืนยันแล้ว กรุณาดูที่การจองของฉัน หรือ {' '}
                            <Link to={`/user/payment-receipt/${booking.id}`}
                                className='font-semibold underline hover:text-green-800 transition-colors'
                            >
                                คลิกที่นี่
                            </Link>{' '}
                            เพื่อดูรายละเอียดการชำระเงิน</span>
                    </div>
                </div>
            )}
